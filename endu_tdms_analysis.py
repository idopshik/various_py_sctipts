...
PRESSURE_UPPER_LIMIT = 200    # Уменьшили для тормозных цилиндров
...
# Обрезка логов
SKIP_AT_START = 4.0           # Пропустить секунд в начале лога
SKIP_AT_END = 4.0             # Пропустить секунд в конце логаKIP_AT_END = 0.0             # Пропустить секунд в конце лога
